...
var (
	...
	NavItems = map[string]Item{
		"stutas": {"Stutas", "", service.StatusScreen},
		"service": {"Service",
	...
	NavIndex = map[string][]string{
		//"":            {"stutas", "canvas", "icons", "widgets", "collections", "containers", "dialogs", "windows", "advanced"},
		"": {"stutas", "service", "advanced", "frpc"},
